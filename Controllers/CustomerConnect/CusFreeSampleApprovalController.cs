...
namespace MVC_API.Controllers.CustomerConnect
{
    public class CusFreeSampleApprovalController : Controller
    {
        ...
        public string GetOverrideApprHeaderStatus([FromForm] CusGetOverrideApprHeaderStatusIn inputParams)
        {
            ...
            try
            {
                ...
                {
                    List<CusGetOverrideApprHeaderStatusOut> listHeader = new List<CusGetOverrideApprHeaderStatusOut>();
                    foreach (DataRow dr in dtDeliveryStatus.Rows)
                    {
                        listHeader.Add(new CusGetOverrideApprHeaderStatusOut
                        {
